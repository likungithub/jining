		...
		<div class="portlet light bordered" style="padding: 5px 10px;">
			<div class="portlet-body" style="padding-top: 0">
							...
							<div class="row search-body" style="margin-left: 10px;margin-bottom: 10px;">
								<div style="clear:both;overflow: hidden;margin-top: 5px;">
									...
									<div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
										...
										<input type="text" class="inputCommon appsysinfo-m" name="jcke" id="ksjcl_jcks" placeholder="请输入检测科室" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
									</div>
									<div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
										<label class="labelCommon labelBg color666 dateLabel-m">检测类别</label>
										<input type="text" class="inputCommon appsysinfo-m" name="jcke" id="ksjcl_jclb" placeholder="请输入检测类别" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
									</div>
									...
									<div class="openMore pull-left" style="margin-bottom: 0px;">
										<div class="date beginTime pull-left">
											...
											<input type="text" class="appsysinfo-m inputCommon " name="starDate" id="ksjcl_startDate" style="border-radius: 0 !important; width: 100px">
											<span>
										...
										<div class="input-group date endTime pull-left">
											<input type="text"  class="inputCommon appsysinfo-m" name="endDate" id="ksjcl_endDate" style="border-radius: 4px 0 0 4px!important;width: 100px">
											<span>
                                        <button class="btn btn-default appsysinfobtn-m" type="button" style="border-left: none;height: 33px;border-radius: 0 4px 4px 0!important;">
                                            <i class="fa fa-calendar"></i>
                                        </button>
									...
									<div class="input-group  search-label-small pull-left" style="display:none;left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;margin-top: 5px;">
										...
										<input type="text" class="inputCommon appsysinfo-m" name="jcry" id="ksjcl_jcry" placeholder="请输入检测人员" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
									</div>
								</div>
								...
								<div style="clear: both;margin-top: 10px;padding-bottom: 10px;">
									<button id="ksjcl_cx" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-search iconMr"></i>查询</button>
									<button id="ksjcl_cz" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-refresh iconMr"></i>重置</button>
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-hover paramsTab" id="ksjcl_ManagerList_m" width="100%">
						<thead>
						<tr class="color333">
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/tjcx/ksjcl.js" type="text/javascript"></script>



<div class="modal fade" id="ksjclModal" tabindex="-1" role="dialog" aria-labelledby="myModalLable" aria-hidden="true">
