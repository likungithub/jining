...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/agentstatistics/agentview.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
    	agentview.setPath("<%=request.getContextPath() %>");
    	agentview.init("<%=request.getParameter("id")%>","<%=request.getParameter("userId")%>", "<%=request.getParameter("dljgbm")%>");
    });
</script>