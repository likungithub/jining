...
<div class="row" id="companyInfoImage">
    <div class="col-md-5" style="border-right: 1px solid #eee;height: 350px;">
        <div class="col-md-12" style="height: <%=height %>;border-bottom: 1px solid #eee;overflow-y: scroll;">
            <ul class="list-group" style="padding-top:20px;padding-bottom: 20px;">
            </ul>
        </div>
        <div class="col-md-12" style="height: 100px;margin-top: 5px;display: <%=display %>">
            <form action="#" id="companyInfoImageForm" class="form form-horizontal" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-12 input-group">
	                            ...
	                            <div class="col-md-5 input-group" id="sfjeinput">
	                               <input type="file" class="form-control" name="file" title="请上传图片！（5M以内）" style="width: 200px !important;">
	                             </div>
	                        </div>
                        </div>
			        </div>
...
<script src="<%=request.getContextPath()%>/securityassets/scripts/companyinfoimage.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        companyInfoImage.setPath('<%=request.getContextPath()%>');
        companyInfoImage.init('<%=id%>','<%=status%>','<%=fjlx%>');
    });
</script>