                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 10px;">
                                ...
                                <div style="clear: both;">
                                    ...
                                    <button id="btn_saoma<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>扫码</button>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/ypgl/ypTh.js" type="text/javascript"></script>
