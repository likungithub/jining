                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 10px;">
                                ...
                                <div style="clear: both;">
                                    ...
                                    <button id="ypth<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>退回</button>
                                    <button id="crkjl<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>出入库记录导出</button>
                                </div>
                                <!--按钮  end-->
                            </div>
                        </div>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/ypgl/ypHy.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        yphy.setPath("<%= request.getContextPath()%>");
        yphy.init("<%=uuid %>");
        //全选
