                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 10px;">
                                <div style="clear:both;">
                                    ...
                                    <div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;">
                                        <label class="labelCommon labelBg color666 dateLabel-m">领取时间</label>
                                        <input type="text" class="inputCommon appsysinfo-m" id="lqsj" value="<%=txtDate%>" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
                                    </div>
                                </div>
                                <br>
                                <div style="clear: both;">
                                    ...
                                    <div class="input-group  search-label-small pull-left"
                                         style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
                                        <label class="labelCommon labelBg color666 dateLabel-m">产品类别</label>
                                ...
                                <div style="clear: both;">
                                    <br>
                                    <button id="btn_ryxz<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" style="display: none"><i class="fa fa-plus iconMr" ></i>接收</button>
                                    <%--<button id="btn_add<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>新增</button>--%>
                                    ...
                                    <button id="scypjs<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>删除</button>

                                    <button id="btn_ypbdc<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>样品簿导出</button>
                                    ...
                                    <button id="btn_dyypbq<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>打印标签</button>-
                                    <button id="savejcx" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>检测项</button>
                                    ...
                                    <button id="btn_daochuYplq" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>打印登记表</button>
                                </div>
                                <!--按钮  end-->
                            </div>
                        </div>
                ...
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-bordered table-hover" id="list_data<%=uuid%>" name="ypjs-table" style="width:100%;margin-top: 15px!important">
                        ...
                        <tr>
                            ...
                            <th width="12%">样品数量</th>
                            <th width="12%">样品单位</th>
                          <%--  <th width="12%" style="display: none">接收状态</th>--%>
                            <th width="12%">是否抽样</th>
                            <th width="12%">保质期</th>
                            <th width="12%">商标</th>
                            <%--<th width="12%">备注</th>--%>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/ypgl/YPLQList.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        ypLqList2.setPath("<%= request.getContextPath()%>");
        ypLqList2.init("<%=uuid %>");
        //全选
