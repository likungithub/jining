                            ...
                            <div class="row search-body" style="margin-left: 10px;">
                                ...
                                <div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;">
                                    <label class="labelCommon labelWidth-col-two labelBg color666">
                                        <span class="colorRed"> * </span>提交时间
                                    </label>
                                    <div class="input-group pull-left">
                                        <div class="input-group date cyDate TjTime<%=uuid%>">
                                ...
                                border-top-right-radius: 0px !important;text-align: center;" value="<%=txtDate%>" id="TjTime<%=uuid%>"/>
                                            <span>
                                ...
                                <div style="clear: both;">
                                    <br>
                                    <button id="btn_ryxz<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>接收</button>
                                    ...
                                    <button id="ypth<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" style="display:none;"><i class="fa fa-plus iconMr"></i>退回</button>
                                    <button id="crkjl<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" style="display: none"><i class="fa fa-plus iconMr"></i>出入库记录导出</button>
                                </div>
                                <!--按钮  end-->
                            </div>
                        </div>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/ypgl/zbypjs.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        zbypjs.setPath("<%= request.getContextPath()%>");
        zbypjs.init("<%=uuid %>");
        //全选
        $("[name='ypjs']").on('click',function () {
            if($("[name='ypjs']").prop("checked")){
                //选中
