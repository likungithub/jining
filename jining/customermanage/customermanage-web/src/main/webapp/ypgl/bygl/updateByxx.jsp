...
<div class="row contentBgColor" id="<%=uuid%>-ypjcEdit-container">
    <div class="dataTables_wrapper no-footer">
        ...
        <form id="jcxtzform<%=uuid%>" >
            ...
            <div class="row" style="margin-left: 15px">
                <div class="form-group">
                    <label class="labelCommon labelWidth-col-two color666">是否合格&nbsp;&nbsp;</label>
                    <select class="appsysinfo-m inputCommon input-width" id="ifhg" name="ifhg" style="outline:none;border: 0;width:415px !important;font-size:12px !important;">
            ...
            <div class="row" style="margin-left: 15px">
                <div class="form-group">
                    <label class="labelCommon labelWidth-col-two color666">保存时间&nbsp;&nbsp;</label>
                    <select class="appsysinfo-m inputCommon input-width" id="bcsj" name="bcsj" style="outline:none;border: 0;width:415px !important;font-size:12px !important;">
                        <option value="">请选择</option>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/ypgl/bygl/updateByxx.js" type="text/javascript"></script>
