            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(list.length>=1){
                        ...
                        var ypmcdom =  jqueryMap.$editForm.find('input[name="bgbzry"]');
                        ypmcdom.val(rymc);
                    }
                    if(list.length>=2){
                        var rymc = list[1].rymc;
                        var ypmcdom =  jqueryMap.$editForm.find('input[name="bgsh"]');
                        ypmcdom.val(rymc);
                    }

                    if(list.length>=3){
                        var rymc = list[2].rymc;
                        var ypmcdom =  jqueryMap.$editForm.find('input[name="bgpz"]');
                        ypmcdom.val(rymc);
                    }

                    if(list.length>=4){
                        var rymc = list[3].rymc;
                        var ypmcdom =  jqueryMap.$editForm.find('input[name="zjsp"]');
                        ypmcdom.val(rymc);
                    }
