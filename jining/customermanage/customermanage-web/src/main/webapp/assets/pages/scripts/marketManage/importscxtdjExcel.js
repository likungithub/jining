var setInExcel = function () {
    ...
    var setJqueryMap = function () {
        ...
        jqueryMap.$selectSpgg = $('#importscxtdjExcel');
    };
    //委托单列表
    ...
    var importDown = function () {
        window.location.href = "/customermanage/scxtgl/downloadScxtdjExcel";
    }
    ...
    var subimtBtn = function (callback) {
        ...
        if (re && selectWt) {
            ...
            var options = {
                url: '/customermanage/scxtgl/importScxtdjExcel?wtid='+wtid,
                type: 'post',
                dataType: 'json',
