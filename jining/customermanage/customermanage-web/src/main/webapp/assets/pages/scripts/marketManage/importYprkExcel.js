var setInExcel = function () {
    ...
    var setJqueryMap = function () {
        ...
        jqueryMap.$selectSpgg = $('#importYprkExcel');
    };

    var showRequest = function () {
        var fileDir = $("#upYprkFile").val();
    ...
    var importDown = function () {
        window.location.href = "/customermanage/yprk/downloadYprkExcel";
    }
    ...
    var subimtBtn = function (callback) {
        ...
        if (re) {
            ...
            var form = $("form[id=formYprk]");
            var options = {
                url: '/customermanage/yprk/importYprkExcel',
                type: 'post',
                dataType: 'json',
    ...
    return {
        ...
        init: function (type) {
            ...
            //下载模板
            $('#importDownYprk').off('click').on('click', function () {
                importDown();
            });
