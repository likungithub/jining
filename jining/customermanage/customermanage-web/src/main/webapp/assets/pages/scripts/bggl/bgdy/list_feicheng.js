var list = function() {
    ...
    var cjhzb = function (dylx) {
        ...
        if(ny==null ||ny=="" || ny.length==0)
        {
            ...
            POBrowser.openWindowModeless('customermanage/bgglFc/bgdyfeicheng/cjhzblist?ypbm='+ypbm+'&ypmc=&ny='+ny+"&dylx="+dylx, 'width=1200px;height=800px;');
    }
    ...
    return {
        init: function(uuid) {
            ...
            $('#dy-cjhzb', jqueryMap.$container).on('click', function () {
                cjhzb("cjhz");
            });
            $('#dy-cjhgb', jqueryMap.$container).on('click', function () {
                cjhzb("hghz");
            });
            $('#dy-cjbhg', jqueryMap.$container).on('click', function () {
                cjhzb("bhghz");
            });
