...
var Customerfiles = function () {
    'use strict';

    // 全局属性参数
    var configMap = {
        path: '',
        dataUrl: '/ptkhxx/addfile',
    ...
    var setJqueryMap = function () {
        ...
        jqueryMap.$contractForm = $('#customerFileAdd');
    };
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    content += '<li class="list-group-item"><span class="opera" id="' + result[i].id + '">' + configMap.deleteBtn_html + '</span><label class="fonthidden">' + result[i].fjmc + '</label></li>';
                }
                ...
                jqueryMap.$contractForm.find('li').off('click').on('click', function () {
                    ...
                    rightcontent += '<div class="col-md-12"><span><a onclick="Customerfiles.getURL(' + '\'' + result[indexsize].fjcclj + '\',' + '\'' + result[indexsize].fjmc + '\',' + '\'' + result[indexsize].id + '\'' + ')" name="downloadfile">下载</a></span></div>';
