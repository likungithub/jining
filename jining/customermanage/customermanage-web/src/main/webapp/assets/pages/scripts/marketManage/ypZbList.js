...
// 全局属性参数
    var configMap = {
        ...
        dataUrl: '/ypgl/getTypzbList',
        editUrl:'/marketManage/ypzb_jcxm.jsp',
        ...
        deleBtn_html: '<a href="javascript:;" class="btn btn-xs default"  data-toggle="tooltip" data-placement="bottom"   name="ypjsdelete" title="删除制备任务"><i class="icon iconfont icon-shanchu3 iconFontColor-10a0f7 iconFontSize"></i></a>',
...
//         TSCObj.ActiveXbarcode (430, 58, 35, 180, 0, 0, "Arial", "抽(送)检时间:"+s);// 打印内容，参数是位置和字体
    ...
    var zbsave = function () {
        ...
        $.ajax({
            url:"customermanage/datatable/addYpzbList?sb="+JSON.stringify(jcxmjson),
            type:'POST',
            traditional:true,
            success:function (data) {
                Messenger().post("制备完成");
