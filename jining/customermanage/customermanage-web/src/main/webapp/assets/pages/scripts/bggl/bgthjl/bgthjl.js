var bgthjlList = function() {
    'use strict';
    var prefix = 'bggl/bgthjl';
    // 全局属性参数
    var configMap = {
    ...
    var setJqueryMap = function(uuid) {
        jqueryMap.$container = $('#'+uuid+'-bgThjl-container');
    ...
    return {
        init: function(uuid) {
            ...
            jqueryMap.$container.find("#bgthjlSeach").on("click",function () {//查询
                configMap.thjlListGrid.ajax.reload();
            });
            jqueryMap.$container.find("#bgthjlReast").on("click",function () {//重置
                $("input").val("");
                configMap.thjlListGrid.ajax.reload();
            });
            jqueryMap.$container.find("#bgthjlRemove").on("click",function () {//删除
                 removeBtn();
            });
