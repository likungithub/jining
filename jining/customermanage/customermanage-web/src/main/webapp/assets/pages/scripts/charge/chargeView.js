...
var chargeView = function () {
    ...
    var configMap = {
        ...
        updateUrl: '/charge/chargeupdate',
        receiptUrl: '/charge/receipt.jsp',
        viewPageUrl: '/charge/chargeDetails.jsp',
        id: '',
        chargeGrid: null,
        ...
        receiptBtn_html: '<a class="ta btn btn-sm btnBlue btnBorderColor colorfff borderRadius4" type="button" name="receipt" href="" target="_blank">收据</a>',
...
//		                  + Btn_html
            ...
            "drawCallback": function () { // 数据加载完成后执行
                ...
                var receiptContainer = $('[name="receipt"]', jqueryMap.$container);
