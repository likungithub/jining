var setInExcel = function () {
    ...
    var setJqueryMap = function () {
        ...
        jqueryMap.$selectSpgg = $('#importYpclExcel');
    };

    var showRequest = function () {
        var fileDir = $("#ypclFile").val();
    ...
    var importDown = function () {
        window.location.href = "/customermanage/ypclz/downloadYpclExcel";
    }
    ...
    var subimtBtn = function (callback) {
        ...
        if (re) {
            ...
            var form = $("form[id=formYpcl]");
            var options = {
                url: '/customermanage/ypclz/importYpclExcel',
                type: 'post',
                dataType: 'json',
    ...
    return {
        ...
        init: function (type) {
            ...
            //下载模板
            $('#importDownYpcl').off('click').on('click', function () {
                importDown();
            });
