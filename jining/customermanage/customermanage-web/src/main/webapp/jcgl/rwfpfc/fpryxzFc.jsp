        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="inputCommon inputWidth-col-two" name="rwfp_ypjc" id="rwfp_ypjc" multiple="multiple">
                    </select>
                    <br/>
                </div>
                <br>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/jcgl/rwfpfc/fpryxzFc.js" type="text/javascript"></script>
