                                    ...
                                    <div style="clear:both;overflow: hidden;margin: 5px auto;">
                                        ...
                                        <div style="clear: both;padding-top: 10px">
                                            ...
                                            <div class="input-group  search-label-small pull-left"
                                                ...
                                                <select name="zbks" class="appsysinfo-m inputCommon" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;">
                                                    <option value="">下拉选择制备科室</option>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/jcgl/rwfpfc/rwfpFclist.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        rwfpFclist.setPath("<%= request.getContextPath()%>");
        rwfpFclist.init('<%=uuid%>');
