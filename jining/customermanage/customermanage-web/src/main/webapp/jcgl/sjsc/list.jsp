			...
			<div class="portlet-body" style="padding-top: 0">
							...
							<div class="row search-body" style="padding-bottom: 10px;">
								...
								<div>
									<%--<div class="col-md-6b " style="padding: 0">--%>
										<button style="margin-left: 10px" id="<%=uuid%>btn_sjfh_tg" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
											<i class="fa fa-plus iconMr"></i>通过
										</button>
										<button id="searchTerm-sjsh"
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-hover paramsTab" id="<%=uuid%>ManagerList_m" width="100%">
						<thead>
						<tr class="color333">
							<th width="20px" class="text-left"><input type="checkbox" name="rwfp_checkbox"/>
							</th>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/jcgl/sjsc/list.js" type="text/javascript"></script>
