				...
				<div class="table-toolbar" style="margin-bottom: 0">
							...
							<div class="row search-body" style="margin-left: 10px;margin-bottom: 10px;">
								<div style="clear:both;overflow: hidden;margin-top: 5px;">
									<div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
										...
										<input type="text" class="inputCommon appsysinfo-m" name="" id="mdname<%=uuid%>" placeholder="请输入名称" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
									</div>
					<%--				<div class="openMore pull-left" style="margin-bottom: 0px;">
								...
								<div style="clear: both;margin-top: 10px;padding-bottom: 10px;">
									<button  class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" id="chaxun<%=uuid%>"><i class="fa fa-search iconMr"></i>查询</button>
									...
									<button class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" id="addbgmodel<%=uuid%>"><i class="fa fa-plus iconMr"></i>新增</button>
<%--									<button class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>修改</button>--%>
									<button class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" id="scbgmodel<%=uuid%>"><i class="fa fa-plus iconMr"></i>删除</button>
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-hover paramsTab" id="<%=uuid%>ManagerList_m" width="100%">
						<thead>
						<tr class="color333">
							<th class="text-left"><input type="checkbox" id="bgmbcb" name="bgmbcb"></th>
							<th class="text-left">名称</th>
							<th class="text-left">版本</th>
							<th class="text-left">上传人</th>
							<th class="text-left">上传时间</th>
							<th class="text-left">存储位置</th>
							<th class="text-left">模板预览</th>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/bggl/bgmbdz/bgmbdz.js"></script>
<script type="text/javascript">
	$(document).ready(function () {
		bgmodel.init('<%=uuid%>');
        $("[name='bgmbcb']").on('click',function () {
            if($("[name='bgmbcb']").prop("checked")){
                //选中
