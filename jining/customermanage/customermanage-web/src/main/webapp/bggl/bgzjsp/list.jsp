...
<%--退回原因模态框--%>
    <div class="modal fade" id="bgthyy" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width:550px;height:350px;">
            <div class="modal-content">
                ...
                <div class="col-md-12" style="position: relative;margin-top: 10px;margin-bottom: 10px">
                    ...
                    <textarea rows="3" class="form-control "  id="thyy" maxlength="300" style="height: 130px;
                ...
                <div class="modal-footer" >
                    ...
                    <button type="button" class="btn btn-primary " id="tjthyy" >
                        提交
                    </button>
                </div>
            </div><!-- /.modal-content -->
                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="padding-bottom: 10px;">
                                ...
                                <div>
                                    ...
                                    <button id="<%=uuid%>xiazai"
                                            class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                                        <i class="fa fa-refresh iconMr"></i>报告下载
                                    </button>
                                    <button id="<%=uuid%>showdzcyd" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>电子抽样单</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/bggl/bgzjsp/list.js" type="text/javascript"></script>
<script src="<%= request.getContextPath()%>/bggl/bgzjsp/laydate/laydate.js"></script>
<!-- 改成你的路径 -->
<script type="text/javascript">
    $(function () {
        bgzshlist.setPath("<%= request.getContextPath()%>");
        bgzshlist.init('<%=uuid%>');
        bgzshlist.setDzcydPath("<%= basePath%>");
