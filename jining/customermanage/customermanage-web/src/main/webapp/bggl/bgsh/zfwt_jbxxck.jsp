        ...
        <div>
            <table class="gridpt" style="table-layout: fixed;border:3px solid blue">
                <tbody>
                    ...
                    <tr class="gridpt">
                        <th class="hint title_font">凭证编号<span class="required"> * </span></th>
                        <td>
                            <input type="text" id="chouyangdanbianhao" name="cydbm" class="easyui-validatebox input_bg validatebox-text">
                        </td>
                        <th class="hint title_font">样品名称<span class="required"> * </span></th>
                        <td>
                    ...
                    <tr class="gridpt">
                        <th class="hint title_font">受检单位</th>
                        <td>
                    ...
                    <tr class="gridpt">
                        <th class="hint title_font">生产企业</th>
                        <td>
                    ...
                    <tr class="gridpt">
                        <th class="hint title_font">检验类别</th>
                        <td>
                    ...
                    <tr class="gridpt">
                        ...
                        <th class="hint title_font">生产/加工/购进日期</th>
                        <td>
                    ...
                    <tr class="gridpt">
                        <th  class="hint title_font">执行标准/技术文件<span class="required"> * </span></th>
                        <td>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/bggl/bgsh/zfwt_jbxxck.js" type="text/javascript"></script>
...
<script type="text/javascript">
    $(function() {
        ckzfwt.setPath('<%=request.getContextPath()%>');
        ckzfwt.init('${id}', '<%=uuid%>');
    ...
    function DisableElements()
    {
        ...
        //$("#zfwt_jbxx<%=uuid%>").children("input").attr("disabled", "disabled");
    }
</script>