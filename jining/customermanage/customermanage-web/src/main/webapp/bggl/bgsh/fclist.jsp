...
<%--退回原因模态框--%>
<div class="modal fade" id="shthyy" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width:550px;height:350px;">
        <div class="modal-content">
            ...
            <div class="col-md-12" style="position: relative;margin-top: 10px;margin-bottom: 10px">
                ...
                <textarea rows="3" class="form-control "  id="shth" maxlength="300" style="height: 130px;
            ...
            <div class="modal-footer" >
                ...
                <button type="button" class="btn btn-primary " id="shtjthyy" >
                    提交
                </button>
            </div>
        </div><!-- /.modal-content -->
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/bggl/bgsh/fclist.js" type="text/javascript"></script>
<script src="<%= request.getContextPath()%>/bggl/bgsh/laydate/laydate.js"></script>
<!-- 改成你的路径 -->
<script type="text/javascript">
    $(function () {
        list.setPath("<%= request.getContextPath()%>");
        list.setDzcydPath("<%= basePath%>");
        list.init('<%=uuid%>');
