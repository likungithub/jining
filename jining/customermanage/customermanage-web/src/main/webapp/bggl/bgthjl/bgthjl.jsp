...
%>
<div class="row contentBgColor" id="<%=uuid%>-bgThjl-container">
    <div class="col-md-12">
                            ...
                            <div class="row search-body" style="padding-bottom: 10px;">
                                <div style="float: right;width:100%;">
                                    ...
                                    <div class="col-md-6b " style="padding: 0">
                                        <button id="bgthjlSeach" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                                            <i class="fa fa-search iconMr"></i>
                                            查询
                                        </button>
                                        <button  style="margin-left: 10px" id="bgthjlReast" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                                            <i class="fa fa-refresh iconMr"></i>
                                            重置
                                        </button>
                                        <button  style="margin-left: 10px" id="bgthjlRemove" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                                            <i class="fa fa-refresh iconMr"></i>
                                            删除
                                        </button>
                                    </div>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/bggl/bgthjl/bgthjl.js" type="text/javascript"></script>
<script type="text/javascript">
    bgthjlList.setPath("<%=request.getContextPath()%>");
    bgthjlList.init("<%=uuid%>");
</script>
