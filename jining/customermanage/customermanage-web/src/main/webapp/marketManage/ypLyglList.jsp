                            ...
                            <div class="row search-body" style="margin-left: 10px;">
                                <div style="clear:both;overflow: hidden;">
                                    <%--<div class="input-group  search-label-small pull-left"
                                        ...
                                        <select name="jcxm"
                                                style="height: 33px;width: 214px !important;border: 1px solid #e5e5e5 !important;border-radius: 0 4px 4px 0 !important;">
                                            <option></option>
                                            <option value="山梨酸及其钾盐(以山梨酸计)">山梨酸及其钾盐(以山梨酸计)</option>
                                            <option value="铅（以Pb计）">铅（以Pb计）</option>
                                            <option value="总汞（以Hg计）">总汞（以Hg计）</option>
                                            <option value="铬（以Cr计）">铬（以Cr计）</option>
                                            <option value="酸度">酸度</option>
                                            <option value="安赛蜜">安赛蜜</option>
                                        </select>
                                    </div>--%>
                                    <div class="input-group  search-label-small pull-left"
                                         style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
                                    ...
                                    <div class="input-group  search-label-small pull-left"
                                         style="left: -3px;margin-left: 3px;position:relative;;width:290px!important;border-radius: 4px!important;overflow: hidden;">
                                        <label class="labelCommon labelBg color666 dateLabel-m">样品编号</label>
                                        <input type="text" class="inputCommon appsysinfo-m" name="ypbm"
                                               placeholder="请输入样品编号"
                                               style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;"/>
                                    </div>
                                    <%--<div class="openMore pull-left" style="margin-bottom: 0px;">
                                        <div class="date beginTime pull-left">
                                            <label class="labelCommon labelBg color666 dateLabel-m"
                                                   style="width: 80px !important;">数据出具日期</label>
                                            <input type="text" readonly="" class="appsysinfo-m inputCommon "
                                                   name="sjcjrqstart" style="border-radius: 0 !important; width: 100px">
                                            <span>
                                        ...
                                        <div class="input-group date endTime pull-left">
                                            <input type="text" readonly="" class="inputCommon appsysinfo-m"
                                                   name="sjcjrqend"
                                    ...
                                    <div class="input-group  search-label-small pull-left"
                                         style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;">
                                        <label class="labelCommon labelBg color666 dateLabel-m">组名</label>
                                        <input type="text" class="inputCommon appsysinfo-m" name="zm"
                                               placeholder="请输入组名"
                                               style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;"/>
                                    </div>--%>
                                    <div class="input-group  search-label-small pull-left"
                                        ...
                                        <input type="text" class="inputCommon appsysinfo-m" name="jcff"
                                               placeholder="请输入检测方法"
                                               style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;"/>
                                    </div>
                                </div>
<br>
                ...
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-bordered table-hover" id="list_data" name="yplz-table"
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/ypLyglList.js"
