        ...
        <div class="portlet light bordered" style="padding: 8px">
            <div class="portlet-body" style="margin-top: 0;padding-top: 0">
                            ...
                            <div class="row search-body" style="margin-left: 10px;">
                                <div style="clear:both;overflow: hidden;">
                                    ...
                                    <div class="input-group  search-label-small pull-left"
                                        ...
                                        <input type="text" class="inputCommon appsysinfo-m" name="jcxm"
                                               placeholder="请输入检测项目"
                                               style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;"/>
                                    </div>
                                </div>
                                ...
                                <div style="clear: both;">
                                    <button id="btn_dy"
                                        ...
                                        <i class="fa fa-plus iconMr"></i>打印
                                    </button>
                                    <button id="Search"
                                            class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                ...
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-bordered table-hover" id="tmdy_data" name="tmdy-table"
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/tmdy.js" type="text/javascript"></script>
<script src="<%= request.getContextPath()%>/assets/pages/laydate/JsBarcode.all.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        tmdylist.setPath("<%= request.getContextPath()%>");
        tmdylist.init("<%=uuid %>");
    });
