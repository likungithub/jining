...
<%
    ...
    String ypzbid = request.getParameter("ypzbid");
    if(frompage == null ){
        frompage = "";
    }
%>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/jcxmlistcyd.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        jcxmlist.setPath("<%= request.getContextPath()%>");
        jcxmlist.init('<%=uuid %>', '<%=ypids%>','<%=frompage%>','<%=ypzbid%>');
    });
</script>