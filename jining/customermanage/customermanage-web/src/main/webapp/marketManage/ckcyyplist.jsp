                                ...
                                <div class="row search-body" style="margin-left: 10px;">
                                    <%--<div style="clear:both;overflow: hidden;">--%>
                                        <%--<div class="input-group  search-label-small pull-left"--%>
                                            ...
                                            <input type="hidden" class="appsysinfo-m inputCommon" name="ypmc"
                                                   placeholder="请输入样品名称"
                                    ...
                                    <div style="clear: both;">
                                        ...
                                        <button id="cleanjcx"
                                                class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">
                                            <i class="fa fa-search iconMr"></i>批量清理检测项
                                        </button>
                                        <%--<button id="reset"--%>
                                                <%--class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4">--%>
                    ...
                    <div class="portlet-scroller">
                        <div class="dataTables_wrapper no-footer">
                            <table class="table table-striped table-bordered table-hover" id="yplist_data">
                                <thead>
                                <tr>
                                    <th width="20px" class="text-left"><input type="checkbox" name="check1"/></th>
                                    ...
                                    <th class="text-center">样品数量</th>
                                    <th class="text-center">样品单位</th>
                    ...
                    <div class="portlet-scroller">
                        <div class="dataTables_wrapper no-footer">
                            <table class="table table-striped table-bordered table-hover" id="jcxmlist_data">
                                <thead>
                                <tr>
                                    <th width="20px" class="text-left"><input type="checkbox" name="check2"/></th>
                                    <th class="text-center">检测项目名称</th>
                                    <th class="text-center">细类</th>
                                    <th class="text-center">检出限</th>
                                    <th class="text-center">限量值</th>
                                    <th class="text-center">检测方法</th>
                                    <th class="text-center">检测依据</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
