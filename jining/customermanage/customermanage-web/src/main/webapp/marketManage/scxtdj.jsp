        ...
        <div class="portlet light bordered" style="padding: 8px">
            <div class="portlet-body" style="margin-top: 0;padding-top: 0">
                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 10px;">
                                ...
                                <div style="clear: both;">
                                    <button id="selectscxtdj" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>查询</button>
                                    <button id="resetscxtdj"  class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-refresh iconMr"></i>重置</button>
                                    <button id="btn_daochuscbg" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>导出Excel报告</button>
                                    <button id="btn_drscxtdj" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>导入Excel报告</button>
                                </div>
                                <!--按钮  end-->
                            </div>
                        </div>
                ...
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-hover paramsTab" id="scxtdjfeiqiu" width="100%">
                        <thead>
                        <tr class="color333">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bootbox-body">
                    <table class="table table-striped table-hover paramsTab" id="selectExcelSc" style="width:4000px;table-layout: fixed;">
                        <thead>
                        <tr class="color333">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/pages/scripts/marketManage/scxtdj.js"></script>
