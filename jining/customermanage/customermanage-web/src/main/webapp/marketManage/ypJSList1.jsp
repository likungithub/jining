						...
						<div class="col-md-12">
							<div class="row search-body" style="margin-left: 10px;">
								...
								<div style="clear: both;">
									...
									<button id="btn_dyypbm<%=uuid%>" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4" style="display: none"><i class="fa fa-plus iconMr"></i>打印样品编码</button>
								</div>
								<!--按钮  end-->
							</div>
						</div>
