...
<div id="jcxm_jbxx<%=uuid%>">
    <form id="add_form" method="post" style="width: 100%; height: 50%;">
        <table class="gridpt" style="table-layout: fixed">
            ...
            <tr class="gridpt">
                <th>微生物m值</th>
                <td>
                    <input type="text" id="weishengwuXMzhi" name="wswxmz" class="easyui-validatebox input_bg validatebox-text">
                </td>
                <th>微生物C值</th>
                <td>
    ...
    <div style="clear: both;padding:5px;" class="center-block">
        <button id="addButJcxm" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>保存</button>
    </div>
    <!--按钮  end-->
</div>
<script src="<%=request.getContextPath()%>/assets/pages/scripts/marketManage/jcxm_addjbxx.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        addJcxm.setPath('<%=request.getContextPath()%>');
        addJcxm.init('<%=id%>', '<%=uuid%>');
    });
</script>