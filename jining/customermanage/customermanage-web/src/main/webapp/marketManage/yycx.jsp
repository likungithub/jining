...
<br>
								...
								<div style="clear: both;">
									<button id="yycxSearch" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-search iconMr"></i>查询</button>
									<button id="yycxReset" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-refresh iconMr"></i>重置</button>
								</div>
								<!--按钮  end-->
							</div>
						</div>
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-bordered table-hover" id="yycx_tname" name="ypjs-table" style="width:100%;margin-top: 15px!important">
						<thead>
							<tr>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/pages/scripts/marketManage/yycx/yycx.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
        <!-- 重置查询条件-->
        $("#yycxReset").click(function () {
            $("input").val("");
        });
    });
</script>
<%-- <script src="<%= request.getContextPath()%>/assets/pages/scripts//marketManage/yycl.js" type="text/javascript"></script> 
<script type="text/javascript">
	$(function() {
