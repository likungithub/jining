...
<%--                        <input type="text" id="beizhu" name="bz" class="easyui-validatebox input_bg validatebox-text">--%>
    ...
    <div style="clear: both;padding:5px;" class="center-block">
        ...
        <button id="saveQYWTDy" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>保存并打印</button>
        <button id="qy_WtXZ" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>历史抽样单</button>
