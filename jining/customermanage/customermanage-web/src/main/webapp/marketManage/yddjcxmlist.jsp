                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 10px;">
                                <div style="clear:both;overflow: hidden;">
                                    ...
                                    <div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
                                        <label class="labelCommon labelBg color666 dateLabel-m">检验依据</label>
                                        <input type="text" class="appsysinfo-m inputCommon" name="jyyj" placeholder="请输入检验依据" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
                                    </div>
                                </div>
                                <!--按钮  begin-->
                            ...
                            <div class="row search-body" style="margin-left:10px;margin-bottom: 10px;">
                                <div style="clear:both;overflow: hidden;margin-top: 5px;">
                                    <div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:700px!important;border-radius: 4px!important;overflow: hidden;">
                                        ...
                                        <div class="inputCommon appsysinfo-m" id="add_jcxm"  style="outline:none;border: 0;text-indent:0px !important;width:604px !important;font-size:12px !important; line-height: 30px" ></div>
                                    </div>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/yddjcxmlist.js" type="text/javascript"></script>
