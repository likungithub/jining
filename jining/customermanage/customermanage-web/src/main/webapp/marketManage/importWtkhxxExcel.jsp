...
<div class="dataTables_wrapper no-footer" id="importWtkhxxExcel" style="width: 100%">
    <div class="auto-table-area" unselectable="on" onselectstart="return false;" style="-moz-user-select:none;">
        <form method="POST" enctype="multipart/form-data" id="formWtkuxx">
            <table class="table table-striped table-bordered table-hover" id="incel_data" style="margin-top: 10px;">
                ...
                <tr>
                    ...
                    <td><input id="upWtkhxxFile" type="file" name="upWtkhxxFile"></td>
                </tr>
                <tr>
                    <td colspan="2"><span>温馨提示：请下载统一的模版，并按相应的格式在Excel软件中填写您的业务数据，然后再导入到系统中</span>
                        <br/><a href="javascript:;" id="importDownWtkhxx">下载模板</a></td>
                </tr>
                </thead>
            </table>
        </form>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/marketManage/importWtkhxxExcel.js"></script>
<script type="text/javascript">
    setInExcelWtkhxx.setPath('<%=request.getContextPath()%>');
    setInExcelWtkhxx.init("<%=type%>");
</script>
