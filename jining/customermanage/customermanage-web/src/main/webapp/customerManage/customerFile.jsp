...
<style>
    ...
    #customerFileAdd #picList_m > li:nth-child(1) {
        margin-top: 21px;
    }
                        ...
                        <div class="form-group">
                            <div class="col-md-12 input-group">
                                ...
                                <div class="col-md-5 input-group" id="sfjeinput">
                                    <input type="file" class="form-control" name="file" title="请上传附件！（单个文件5M以内，单个图片3M以内！）"
                                           style="width: 200px;">
                                </div>
                            </div>
                        </div>
...
<script
        src="<%=request.getContextPath()%>/assets/pages/scripts/customerManage/customerfile.js"
        type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        Customerfiles.setPath('<%=request.getContextPath()%>');
        Customerfiles.init('<%=uuid %>');
    });
</script>