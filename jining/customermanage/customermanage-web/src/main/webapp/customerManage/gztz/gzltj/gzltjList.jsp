                            ...
                            <div class="row search-body" style="margin-left: 5px;">
                                <div style="margin-left: 5px;clear:both;overflow: hidden;">
                                    <div class="input-group  search-label-small pull-left"
                                        ...
                                        <input type="text" class="inputCommon appsysinfo-m" name="ryxm" id="ryxm<%=uuid%>"
                                               placeholder="请输入人员名称"
            ...
            <form id="lygl_form">
                <div class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-bordered table-hover" id="list_data<%=uuid%>" name="ypjs-table" style="width:100%;margin-top: 15px!important">
                        <thead>
                        <tr>
                            <th width="120px">人员</th>
                            <th width="120px">委托受理数量</th>
                            <th width="12%">样品领取数量</th>
                            <th width="12%">主检人检测数量</th>
                            <th width="12%">报告编制数量</th>
                            <th width="12%">报告批准数量</th>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/gztz/gzltj/gzltjList.js" type="text/javascript"></script>
<script type="text/javascript">
    ...
    $(function() {
        ...
        ypJsList2.init("<%=uuid %>","<%=dyt%>","<%=zhyt%>");
    });
    function goto(obj,lie)
    {
        ypJsList2.openmx(obj,lie);
    }
</script>