		...
		<div class="portlet light bordered" style="padding: 8px">
			<div class="portlet-body" style="margin-top: 0;padding-top: 0">
						...
						<div class="col-md-12">
							<div class="row search-body" style="margin-left: 10px;">
								<div style="clear:both;overflow: hidden;">
									...
									<div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
										<label class="labelCommon labelBg color666 dateLabel-m">产品大类名称</label>
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-bordered table-hover" id="jcxmlist_data1" style="width:100%;margin-top: 15px!important">
						<thead>
							<tr>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/marketManage/jcxmbao/jcxmlist.js" type="text/javascript"></script>
<script type="text/javascript">
	$(function() {
		jcxmlist.setPath("<%= request.getContextPath()%>");
		jcxmlist.init('<%=uuid %>', '<%=jcbid%>');
	});
</script>