...
<div id="ypList-manager-content">
    <div class="ui-layout-west" id="ypList" style="padding: 10px!important;">
            ...
            <div class="portlet">
                <div class="portlet-body form" style="overflow-x:hidden;min-height: 242px">
                    <div class="table-toolbar" style="margin: 0">
                                ...
                                <div class="col-md-12" style="background: #fff;padding-right: 8px;padding-left: 0">
                                  <%--  <select id="selectType1" style="width:140px; border-top-right-radius:4px !important;border-bottom-right-radius:4px !important;height:33px;border-top-right-radius: 0px !important;
								    ...
								    border-bottom-right-radius: 4px !important;">
                                        &lt;%&ndash;<option value="001">产品大类</option>&ndash;%&gt;
                        ...
                        <%--</button>--%>
                        <button id="delJcb" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>批量删除</button>
                        <button id="addJcb" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>新增检测包</button>
                        <button id="btn_drjcb" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>导入检测包</button>
                        <button id="btn_dcjcb" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>导出检测包</button>
                    </div>
    ...
    <div class="ui-layout-center" id="jcxmList"  style="padding: 10px!important;">
        <div class="ui-layout-content contentBgColor" style="background:#fff!important;padding: 0;">
            <div class="portlet">
                <div class="portlet-body form" style="overflow-x:hidden;min-height: 242px">
                    <div class="table-toolbar" style="margin: 0">
                    ...
                    <div class="portlet-scroller">
                        <div class="dataTables_wrapper no-footer">
                            <table class="table table-striped table-bordered table-hover backgroundWhite"
                                ...
                                <thead>
                                <tr>
                                    <th width="16px" style="padding-left: 6px" class="text-left"><input type="checkbox" name="selectjcxmlist"/>
                                    <th align="center">检测项目名称</th>
                                    <th>细类</th>
                                    <th>限量值 </th>
                                    <th>计量单位</th>
                                    <th>判定依据</th>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/marketManage/jcxmbao/jcxmbao.js"
