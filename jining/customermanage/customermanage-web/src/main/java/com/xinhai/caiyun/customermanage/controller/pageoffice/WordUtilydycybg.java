 ...
 * @Modified By:
 */
public class WordUtilydycybg {

    private static Configuration configuration = null;

    public WordUtilydycybg(){
        configuration = new Configuration();
        configuration.setDefaultEncoding("UTF-8");
    }

    public static void main(String[] args) {
        WordUtilydycybg test = new WordUtilydycybg();
    ...
    public static String createWord(HttpServletRequest request,Map<String,Object> dataMap){
        String fileurl = "";
        String filename = "Ydycybg"+UUID.randomUUID()+".doc";
        ...
        try {
            ...
            if(request==null) {
                configuration.setDirectoryForTemplateLoading(
                        new File("D:/file"));
                t = configuration.getTemplate("ydycybgmodel.ftl"); //获取模板文件
            }else {
