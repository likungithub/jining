 ...
 * @Modified By:
 */
public class WordUtilYddcy {

    private static Configuration configuration = null;

    public WordUtilYddcy(){
        configuration = new Configuration();
        configuration.setDefaultEncoding("UTF-8");
    }

    public static void main(String[] args) {
        WordUtilYddcy test = new WordUtilYddcy();
    ...
    public static String createWord(HttpServletRequest request,Map<String,Object> dataMap){
        String fileurl = "";
        String filename = "Yddcybg"+UUID.randomUUID()+".doc";
        ...
        try {
            ...
            if(request==null) {
                configuration.setDirectoryForTemplateLoading(
                        new File("D:/file"));
                t = configuration.getTemplate("yddcybgmodel.ftl"); //获取模板文件
            }else {
