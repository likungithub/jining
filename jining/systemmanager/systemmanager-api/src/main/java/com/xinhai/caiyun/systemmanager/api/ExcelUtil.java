...
public class ExcelUtil {
    ...
    public static XSSFWorkbook createExcelFiles(Class clazz, List objs, Map<Integer, List<ExcelBean>> map,Class claz,List obj,Map<Integer, List<ExcelBean>> map1,XSSFWorkbook workbook,XSSFSheet sheet,XSSFSheet sheet1,int izz) throws
            IllegalArgumentException,IllegalAccessException,InvocationTargetException,
            ClassNotFoundException, IntrospectionException, ParseException {
...
/*        // 创建新的Excel工作簿
        ...
        // 在Excel工作簿中建一工作表，其名为缺省值, 也可以指定Sheet名称
            ...
            if (izz==1){
                ...
                createTableRows(sheet1, map1, obj, claz); //创建内容
            }

        return workbook;
    }

    public static XSSFWorkbook createExcelFiles1(Class clazz, List objs, Map<Integer, List<ExcelBean>> map,Class claz,List obj,Map<Integer, List<ExcelBean>> map1,XSSFWorkbook workbook,XSSFSheet sheet,XSSFSheet sheet1,int izz,int j,int i) throws
            IllegalArgumentException,IllegalAccessException,InvocationTargetException,
            ClassNotFoundException, IntrospectionException, ParseException {
...
/*        // 创建新的Excel工作簿
    ...
    public static void createFont(XSSFWorkbook workbook) {
     ...
     /*   font1.setBoldweight(XSSFFont.U_NONE);*/
    ...
    public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz)
        ...
        for (int index = 0; index < widths.size(); index++) {
            ...
            width = width < 3500 ? 3500 : width + 300;
