            ...
            <table class="table table-striped table-hover paramsTab">
                <tr>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="hcmc2" type="text" class="form-control"
                    ...
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="gg2" type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="jb2" type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="sl2" type="number" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group input-group"
                             style="left: -3px;margin-left: 3px;position:relative;;width:300px!important;border-radius: 4px!important;overflow: hidden;">
                            <span class="input-group-addon"><label style="width: 80px !important;">品牌</label></span>
                            <input id="sccj2"  type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <span class="input-group-addon"><label
                                    style="width: 80px !important;">存放位置</label></span>
                            <input id="cfwz2" type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="dj2" type="number" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="zj2" type="number" class="form-control"
                                   style=";text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group input-group"
                            ...
                            <select id="hclx2" class="form-control"
                                    style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                                <%
                                    if ("ybhc".equals(zl)) {
                                %>
                    ...
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="bz2" type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
...
<script type="application/javascript" src="<%=request.getContextPath()%>/assets/pages/scripts/kcgl/edit_kcgl.js"></script>
<script type="application/javascript">
    edit_kcglList.init("<%=request.getContextPath()%>","<%=uuid%>");
    edit_kcglList.setId("<%=id%>");
</script>