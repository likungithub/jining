                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group input-group"
                            ...
                            <input id="cgmd2" type="text" class="form-control"
                                   style="text-indent:0px !important;width:220px !important;font-size:12px !important;">
                        </div>
                    </td>
                </tr>
...
<script type="application/javascript" src="<%=request.getContextPath()%>/assets/pages/scripts/cgsq/edit_cgsq.js"></script>
<script type="application/javascript">
    edit_cgsqList.init("<%=request.getContextPath()%>","<%=uuid%>");
    edit_cgsqList.setId("<%=id%>");
</script>