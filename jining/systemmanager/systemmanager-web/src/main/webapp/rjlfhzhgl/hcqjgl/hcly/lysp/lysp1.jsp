        ...
        <div class="portlet light bordered" style="padding: 5px 10px;">
            <div class="portlet-body" style="padding-top: 0">
                ...
                <div class="dataTables_wrapper no-footer">
                    <form id="manage_th">
                        <table class="table table-striped table-hover paramsTab" id="lysp1_list" width="100%">
...
<script type="application/javascript"
        src="<%=request.getContextPath()%>/assets/pages/scripts/hcly/lysp/lysp1.js"></script>
<script type="application/javascript">
    lysp1List.setPath("<%=request.getContextPath()%>");
    lysp1List.inint("<%=uuid%>");
</script>