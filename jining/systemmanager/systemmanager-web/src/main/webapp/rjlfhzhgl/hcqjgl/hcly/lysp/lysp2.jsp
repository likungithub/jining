        ...
        <div class="portlet light bordered" style="padding: 5px 10px;">
            <div class="portlet-body" style="padding-top: 0">
                        ...
                        <div class="col-md-12">
                            <div class="row search-body" style="margin-left: 0px;margin-bottom: 10px;">
                                <div style="clear:both;overflow: hidden;margin-top: 5px;">
                                    <input type="text" name="hclx" style="display: none">
                ...
                <div class="dataTables_wrapper no-footer">
                    <form id="manage_th">
                        <table class="table table-striped table-hover paramsTab" id="lysp2_list" width="100%">
                            <thead data-options="frozen:true">
                            <tr class="color333">
                                <th class="text-left" width="10px"><input type="checkbox" name="lyspCheck"></th>
...
<script type="application/javascript"
        src="<%=request.getContextPath()%>/assets/pages/scripts/hcly/lysp/lysp2.js"></script>
<script type="application/javascript">
    lysp2List.setPath("<%=request.getContextPath()%>");
    lysp2List.inint("<%=uuid%>");
</script>