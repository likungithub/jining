...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/kcgl/importKcglExcel.js"></script>
<script type="text/javascript">
    setInKcglExcel.setPath('<%=request.getContextPath()%>');
    setInKcglExcel.init("<%=type%>","<%=uuid%>");
</script>