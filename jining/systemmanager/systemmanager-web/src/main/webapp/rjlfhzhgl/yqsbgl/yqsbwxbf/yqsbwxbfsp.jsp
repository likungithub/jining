		...
		<div class="portlet light bordered" style="padding: 5px 10px;">
			<div class="portlet-body" style="padding-top: 0">
						...
						<div class="col-md-12">
							<div class="row search-body" style="margin-left: 10px;margin-bottom: 10px;">
								...
								<div style="clear: both;margin-top: 10px;padding-bottom: 10px;">
									...
									<button id="<%=uuid%>yqsbtzSpTg" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>审批通过</button>
									<button id="<%=uuid%>yqsbtzSpTh" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>审批退回</button>
				...
				<div class="dataTables_wrapper no-footer">
					<table class="table table-striped table-hover paramsTab" id="Yqsbtzwxbfsp" width="100%">
						<thead>
						<tr class="color333">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/pages/scripts/wxbfsp/yqsbtzwxbfsp.js"></script>
<script type="text/javascript">
	$(function () {
        yqyysyListyqsbtzwxbfsp.setPath("<%=request.getContextPath()%>");
        yqyysyListyqsbtzwxbfsp.init("<%=uuid%>")
    })
</script>
