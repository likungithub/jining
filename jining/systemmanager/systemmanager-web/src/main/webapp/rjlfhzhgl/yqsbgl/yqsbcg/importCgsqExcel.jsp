...
%>
<div class="dataTables_wrapper no-footer" id="importExcelAreaYqcgsq">
    <div class="auto-table-area" unselectable="on" onselectstart="return false;" style="-moz-user-select:none;">
        <form method="POST" enctype="multipart/form-data" id="formyqsbcgsq" action="/customermanage/zfwt/importExcel/<%=type%>">
            <table class="table table-striped table-bordered table-hover" id="incel_data">
                ...
                <tr>
                    ...
                    <td><input id="upYqcgsqFile" type="file" name="upYqcgsqFile"></td>
                </tr>
                <tr>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/yqsbcg/importCgsqExcel.js"></script>
