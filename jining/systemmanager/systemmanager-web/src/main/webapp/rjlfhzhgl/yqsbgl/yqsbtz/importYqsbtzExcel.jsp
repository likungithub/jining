...
%>
<div class="dataTables_wrapper no-footer" id="importExcelAreaYqcgtz">
        ...
        <form method="POST" enctype="multipart/form-data" id="formyqsbcgtz">
            <table class="table table-striped table-bordered table-hover" id="incel_data">
                ...
                <tr>
                    ...
                    <td><input id="upYqcgtzFile" type="file" name="upYqcgtzFile"></td>
                </tr>
                <tr>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/yqsbtz/importYqsbtzExcel.js"></script>
