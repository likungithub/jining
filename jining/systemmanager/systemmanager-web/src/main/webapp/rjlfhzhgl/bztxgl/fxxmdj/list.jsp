		...
		<div class="portlet light bordered" style="padding: 5px 10px;">
			<div class="portlet-body" style="padding-top: 0">
							...
							<div class="row search-body" style="margin-left: 10px;margin-bottom: 10px;">
								<div style="clear:both;overflow: hidden;margin-top: 5px;">
									<div class="input-group  search-label-small pull-left" style="left: -3px;margin-left: 3px;position:relative;;width:278px!important;border-radius: 4px!important;overflow: hidden;">
										...
										<input type="text" class="inputCommon appsysinfo-m" id="fxxmdj_jcxmc" placeholder="请输入检测项名称" style="outline:none;border: 0;text-indent:0px !important;width:214px !important;font-size:12px !important;" />
									</div>
								...
								<div style="clear: both;margin-top: 10px;padding-bottom: 10px;">
									<button id="fxxmdj_xinzeng" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-plus iconMr"></i>增加</button>
									<button id="fxxmdj_chaxun" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-search iconMr"></i>查询</button>
									<button id="fxxmdj_plshanchu" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-dedent iconMr"></i>批量删除</button>
									<button id="fxxmdj_chongzhi" class="btn btn-default fffBg btnBorderColor colorBlue-10a0f7 mr pull-left borderRadius4"><i class="fa fa-refresh iconMr"></i>重置</button>
				...
				<div class="dataTables_wrapper no-footer">
					<form id="fxxmdj_form_choose">
						<table class="table table-striped table-hover paramsTab" id="fxxmdj_ManagerList_m"  style="width: 400%;">
							<thead>
							<tr class="color333">
								<th class="text-left" width="20px"><input type="checkbox" name="check1" class="check1"></th>
...
<!-- 模态框（Modal） 增加数据模块-->
<div class="modal fade" id="fxxmdj_myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form  class="form form-horizontal" id="fxxmdj_xinzeng_form">
					<div class="form-body">
						<div class="row">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-success" id="fxxmdj_xinzeng_submit">提交</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal -->
</div>
<!-- 修改框-->
<div class="modal fade" id="fxxmdj_myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
			...
			<div class="modal-body">
				<form  class="form form-horizontal" id="fxxmdj_bianji_form">
					<div class="form-body">
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">检测项名称&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="zwmc_bm" id="fxxmdj_zwmc_bm">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">英文名称&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="ywmc" id="fxxmdj_ywmc">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">是否请求判断&nbsp;&nbsp;</label>
									<select name="if_pd" id="fxxmdj_if_pd" class="inputCommon inputWidth-col-two">
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">营养参考价值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="yyckjz" id="fxxmdj_yyckjz" >
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">倍率&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bl" id="fxxmdj_bl">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">检测方法&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="jcff" id="fxxmdj_jcff">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">检测依据&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="jcyj" id="fxxmdj_jcyj">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">检测依据名称&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="jcyjmc" id="fxxmdj_jcyjmc">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">微生物n值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="wswnz" id="fxxmdj_wswnz">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">微生物c值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="wswcz" id="fxxmdj_wswcz">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">微生物m值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="wswmz" id="fxxmdj_wswmz">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">限量值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="xlz" id="fxxmdj_xlz">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">限量值默认值&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="xlzmrz" id="fxxmdj_xlzmrz">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">检出限单位&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bzffjcxdw" id="fxxmdj_bzffjcxdw">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">最小允许限&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bzzxyxx" id="fxxmdj_bzzxyxx">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">最小允许限单位&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bzzxyxxdw" id="fxxmdj_bzzxyxxdw">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">最大允许限&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bzzdyxx" id="fxxmdj_bzzdyxx">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">最大允许限单位&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="bzzdyxxdw" id="fxxmdj_bzzdyxxdw">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">是否系统判断&nbsp;&nbsp;</label>
									<select name="if_xtpd" id="fxxmdj_if_xtpd" class="inputCommon inputWidth-col-two" placeholder="1 是 0否">
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">是否标准方法&nbsp;&nbsp;</label>
									<select name="if_bzff" id="fxxmdj_if_bzff" class="inputCommon inputWidth-col-two">
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">CMA&nbsp;&nbsp;</label>
									<select name="if_cma" id="fxxmdj_if_cma" class="inputCommon inputWidth-col-two">
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">CMAF&nbsp;&nbsp;</label>
									<select name="if_cmaf" id="fxxmdj_if_cmaf" class="inputCommon inputWidth-col-two" >
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									...
									<select name="if_cnas" id="fxxmdj_if_cnas" class="inputCommon inputWidth-col-two" >
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
							...
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">CATL&nbsp;&nbsp;</label>
									<select name="if_catl" id="fxxmdj_if_catl" class="inputCommon inputWidth-col-two">
										<option value=""></option>
										<option value="是">是</option>
										<option value="否">否</option>
									</select>
						...
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">制备质量&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="zbzl" id="fxxmdj_zbzl">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">制备质量单位&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="zbzldw" id="fxxmdj_zbzldw">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									...
									<input type="text" readonly="readonly" class="inputCommon inputWidth-col-two" name="id" id="fxxmdj_id">
								</div>
							</div>
							<div class="col-md-6 col-xs-6">
								<div class="form-group">
									<label class="labelCommon labelWidth-col-two color666">判断编号&nbsp;&nbsp;</label>
									<input type="text" class="inputCommon inputWidth-col-two" name="pdnh" id="fxxmdj_pdnh">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
				<button type="submit" class="btn btn-primary reset_dialog">重置</button>
				<button type="submit" class="btn btn-success" id="fxxmdj_bianji_submit">提交</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal -->
</div>

<script src="<%=request.getContextPath()%>/assets/pages/scripts/bztxgl/fxxmdj.js"></script>
<script>
	fxxmdjList.init();
</script>