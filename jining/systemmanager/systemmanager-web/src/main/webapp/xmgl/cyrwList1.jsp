						...
						<div class="col-md-12">
							<div class="row search-body" style="padding-bottom: 10px;">
								<div style="float: right;width:100%;">
									...
									<%--<button id="<%=uuid%>btn_rwfp" class="btn  btnAdd btnBorderColor colorfff borderRadius4 pull-left">--%>
											<%--任务分配--%>
										<%--</button>--%>
									</div>
...
<script src="<%= request.getContextPath()%>/assets/pages/scripts/xmgl/cyrwList1.js" type="text/javascript"></script>
