            ...
            <div class="dataTables_wrapper no-footer">
               ...
               <%-- <button id="TiJiao" class="btn btnAdd btnBorderColor colorfff borderRadius4 pull-left mr">
                   ...
                   <div style="margin-left: 10px !important;">
                       <div class="checkbox checkbox-success checkbox-inline" style="position: relative ">
                           <input type="checkbox" class="styled" id="inlineCheckbox2" value="option1">
                           <label for="inlineCheckbox2">是否就地制样</label>
                       </div>
                   </div>
...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/xmgl/edit.js" type="text/javascript"></script>
