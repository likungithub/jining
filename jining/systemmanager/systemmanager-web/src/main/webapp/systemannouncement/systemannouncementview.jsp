...
<script src="<%=request.getContextPath()%>/assets/pages/scripts/systemannouncement/systemannouncementview.js" type="text/javascript"></script>
<script type="text/javascript">
	$(function () {
        systemannouncementview.setPath("<%=request.getContextPath() %>");
        systemannouncementview.init("<%=request.getParameter("systemAnnouncementId")%>");
	});
</script>