...
<style>
    ...
    #stepFileAdd #picList_m > li:nth-child(1) {
        margin-top: 21px;
    }
</style>
<div class="row" id="stepFileAdd">
...
<script
        src="<%=request.getContextPath()%>/assets/pages/scripts/taskcenter/stepfile.js"
        type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        stepfiles.setPath('<%=request.getContextPath()%>');
        stepfiles.init();
    });
</script>