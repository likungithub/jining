var yqyysyListyqsbtzwxbfsp = function () {
    var configMap = {
        path:'',
        uuid:'',
        wx:'',
        dataUrl: "systemmanager/yqsbwxbf/yqsbwxbfspSeatch",
        nowData:"",
    };
    var jqueryMap ={
        $ypManageDialog:null,
    ...
    var initGridyqsbwxbfsp = $('#Yqsbtzwxbfsp').DataTable({
    ...
    var updateYqsbWbTh = function () {
        $.ajax({
            url: '/systemmanager/yqsbwxbf/yqsbBfspth',
            data:$("#"+configMap.uuid+"yqsbtzform_delete").serialize(),
            type:'POST',
            success:function () {
                Messenger().post({
    ...
    return{
        init:function (uuid) {
            configMap.uuid = uuid;
            setJqueryMap();
            $("#"+configMap.uuid+"yqsbtzSeatchwxbf",jqueryMap.$container).off('click').on('click',function () {
                findBtnwb();
            });
            $("#"+configMap.uuid+"resetYqsbtzwxbf",jqueryMap.$container).off('click').on('click',function () {
                resetYqsbwb();
            });
            $("#"+configMap.uuid+"yqsbtzSpTg",jqueryMap.$container).off('click').on('click',function () {
                updateYqsbWbSp();
            });
            $("#"+configMap.uuid+"yqsbtzSpTh",jqueryMap.$container).off('click').on('click',function () {
                updateYqsbWbTh();
            });
        },
