...
var product = function () {
	...
	var configMap = {
		...
		productGrid: null,
		editPageUrl: '/csxtpz/editcsxtpz.jsp',
		addPageUrl: '/csxtpz/addcsxtpz.jsp',
		viewPageUrl:'/csxtpz/viewcsxtpz.jsp',
		editBtn_html: '<a href="javascript:;" class="btn btn-xs default" data-type="edit" data-toggle="tooltip" title="编辑参数"><i class="icon iconfont icon-bianji1 iconFontSize"></i></a>',
		deleteBtn_html: '<a href="javascript:;" class="btn btn-xs default" data-type="del" data-toggle="tooltip" title="删除参数"><i class="icon iconfont icon-shanchu3 iconFontSize"></i></a>',
		viewBtn_html:'<a href="javascript:;" class="btn btn-xs default" data-type="view" data-toggle="tooltip" title="查看参数"><i class="icon iconfont icon-xiangqing1 iconFontSize"></i></a>'
	};
	...
	var addProduct = function () {
		openModal('添加参数', configMap.path + configMap.editPageUrl, 'edit');
	};
	//添加产品
	var editProduct = function () {
		...
		var rowIndex = configMap.productGrid.cell(el.parent()).index().row;
		var id = configMap.productGrid.row(rowIndex).data().id;
		openModal('编辑参数', configMap.path + configMap.editPageUrl + "?id=" + encodeURI(id), 'edit');
	};
	//删除产品
