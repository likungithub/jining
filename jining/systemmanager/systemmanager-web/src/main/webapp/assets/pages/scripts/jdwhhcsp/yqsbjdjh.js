var yqyysyListyqsbjdsp = function () {
    var configMap = {
        wx:'',
        dataUrl: "/systemmanager/yqsbjhsp/selectJdjhSp",
        nowData:"",
        uuid:'',
        path:''
    };
    ...
    var initGridyqsbjhsp = $('#Yqsbjdjhsp').DataTable({
        ...
        "ajax": {
            ...
            "data":function (data) {
                data.sbmc=$('#sbmcjdsp').val();
                data.skbh=$('#skbhjdsp').val();
            },
    ...
    /*审批功能*/
    var jdjhsp = function () {
        console.log($("#"+configMap.uuid+"yqsbjdspform_delete").serialize())
        // var spids =[]
        ...
        // }
        $.ajax({
            url:'/systemmanager/yqsbjhsp/jdjhsp',
            data:$("#"+configMap.uuid+"yqsbjdspform_delete").serialize(),
            type:'POST',
            success:function () {
                Messenger().post({
                    message:'审批成功',
    ...
    //退回操作
    var jdjhspth = function () {
        console.log($("#"+configMap.uuid+"yqsbjdspform_delete").serialize())
        $.ajax({
            url:'/systemmanager/yqsbjhsp/jdjhth',
            data:$("#"+configMap.uuid+"yqsbjdspform_delete").serialize(),
            type:'POST',
            success:function () {
                Messenger().post({
    ...
    return{
        init:function (uuid) {
            ...
            //审批操作
            $("#"+configMap.uuid+"yqsbjdjhtg",jqueryMap.$container).off('click').on('click',function () {
                jdjhsp();
            });
            //退回操作
            $("#"+configMap.uuid+"yqsbjdjhth",jqueryMap.$container).off('click').on('click',function () {
                jdjhspth();
            });
        },
