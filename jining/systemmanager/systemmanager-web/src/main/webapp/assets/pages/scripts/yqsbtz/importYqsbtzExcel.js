var setInExcel = function () {
    ...
    var setJqueryMap = function () {
        ...
        jqueryMap.$selectSpgg = $('#importExcelAreaYqcgtz');
    };

    var showRequest = function () {
        var fileDir = $("#upYqcgtzFile").val();
    ...
    var importDown = function () {
        window.location.href = "/systemmanager/yqsb/downloadYqtzExcel";
    }
    ...
    var subimtBtn = function (callback) {
        ...
        if (re) {
            ...
            var options = {
                url: '/systemmanager/yqsb/importYqsbtzExcel',
                type: 'post',
                dataType: 'json',
