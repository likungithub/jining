...
public class DetailTablePolicy_cgys1 extends DynamicTableRenderPolicy {
    private List<RowRenderData> dataList;

    public DetailTablePolicy_cgys1(List dataList) {
    ...
    public void render(XWPFTable xwpfTable, Object o) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            TableTools.mergeCellsHorizonal(xwpfTable, 1+i, 0, 1);
        }
    }
}
