...
@Controller
@RequestMapping("fcwjyl")
public class OpenFcwjWord extends HttpServlet{
	@Autowired
	private DzbglService dzbglService;
	@RequestMapping("/fcwjopenword")
	public String openword(HttpServletRequest request, HttpServletResponse response){
		...
		Map map=dzbglService.findFCwj(Integer.parseInt(pathid));
		String sourePath= (String) map.get("wjlj");
