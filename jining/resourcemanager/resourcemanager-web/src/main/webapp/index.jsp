...
<head>
	...
	<link href="assets/global/plugins/mCustomScrollbar/jquery.mCustomScrollbar.min.css"
		  rel="stylesheet" type="text/css"/>
	<link href="assets/global/plugins/bootstrap-switch/css/bootstrap3/bootstrap-switch.min.css"
		  rel="stylesheet">
	...
	<link href="assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet"
		  type="text/css"/>
	<link href="assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css"
		  rel="stylesheet" type="text/css"/>
	<link href="assets/global/plugins/jquery-layout/layout-default-latest.css" rel="stylesheet"
		  type="text/css"/>
	<!-- 页面级样式 -->
	...
	<link href="assets/layouts/layout1/css/themes/darkblue.css" rel="stylesheet" type="text/css"
		  id="style_color"/>
</head>
...
<div class="page-header navbar navbar-fixed-top">
	<div class="page-header-inner ">
		<div class="page-logo">
			<a href="index.jsp">
				<span class="logo-default">财云管家</span> </a>
		...
		<div class="page-sidebar navbar-collapse collapse">
			<ul class="page-sidebar-menu page-header-fixed " data-keep-expanded="false"
				...
				<li class="nav-item nav-top-menu"><a href="#" class="nav-link nav-toggle"><i
						class="fa fa-tree"></i><span class="title">菜单管理</span><span
						class="arrow"></span></a>
					<ul class="sub-menu">
						<li class="nav-item"><a href="#" url="/resource/resources/list.jsp"
												data-addtab="usermanager"
												class="nav-link nav-toggle"><i
								class="fa fa-user"></i><span class="title">菜单管理</span></a></li>
						<li class="nav-item"><a href="#" url="/resource/resources/set-auth.jsp?id=fe9565a0-e0c2-4656-807f-96c8d589edef&type=org"
												data-addtab="usermanagesdfsdfr"
												class="nav-link nav-toggle"><i
								class="fa fa-user"></i><span class="title">test</span></a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<script src="assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
		type="text/javascript"></script>
<script src="assets/global/plugins/jquery.pin.min.js"></script>
...
<script src="assets/global/plugins/jstree/jstree.plugins.js"></script>
<script src="assets/global/plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js"
		type="text/javascript"></script>
...
<script src="assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"
		type="text/javascript"></script>
...
<script src="assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js"
		type="text/javascript"></script>
<script src="assets/global/plugins/jquery.bootstrap.min.js"></script>
<script src="assets/global/plugins/typeahead/typeahead.bundle.min.js"></script>
<script src="assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="assets/global/plugins/bootstrap-select/js/i18n/defaults-zh_CN.min.js"></script>
<script src="assets/global/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="assets/global/plugins/jquery-layout/jquery.layout-latest.js"></script>
<script src="assets/global/plugins/js.cookie.js" type="text/javascript"></script>
<script src="assets/global/scripts/app.js" type="text/javascript"></script>
<script src="assets/layouts/layout1/scripts/layout.js" type="text/javascript"></script>
<script src="assets/layouts/global/scripts/bootstrap-addtabs.js" type="text/javascript"></script>
</body>
