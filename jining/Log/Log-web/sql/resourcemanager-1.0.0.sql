...
INSERT INTO `resource` (`id`,`func_id`, `description`, `name`, `identifier`, `menu_icon`, `url`, `category`, `parent_id`, `order_no`, enabled, update_date) VALUES
('90e1e9ad-6c30-4d58-93f4-66c5f4da2fac','90e1e9ad-6c30-4d58-93f4-66c5f4da2fac', '', '客户管理', '/**/gxcustomer/**', NULL, '/gxcustomer/gxcustomer/gxcustomer.jsp', 'menu', '902bf15e-318d-4423-8738-9327ba91dbe0', 5, true, now());
