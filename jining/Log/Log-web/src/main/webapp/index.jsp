        ...
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu page-header-fixed " data-keep-expanded="false"
                ...
                <li class="nav-item nav-top-menu"><a href="#" class="nav-link nav-toggle"><i
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="#" url="Log/log.jsp" data-addtab="a8890322-c4c9-41fe-9c3b-0c6df07319e5"
                               class="nav-link nav-toggle">
                                <i class="fa fa-braille"></i><span class="title">日志</span>
                            </a></li>
                    </ul>
                </li>
            </ul>
...
<%--<script src="assets/pages/scripts/appmodel/appmodel.js"></script>--%>
